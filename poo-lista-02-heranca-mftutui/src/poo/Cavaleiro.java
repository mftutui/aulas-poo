...
public class Cavaleiro extends Personagem {
    ...
    public Cavaleiro(JPanel p, String img, int x, int y) {

        super(p, img, x, y);
    }

    /**
     * Desenhando o Cavaleiro, nas coordenadas X e Y, com a imagem 'icone' no
     * JPanel 'pai'
     *
     * @param g objeto do JPanel que será usado para desenhar o Cavaleiro
     */
